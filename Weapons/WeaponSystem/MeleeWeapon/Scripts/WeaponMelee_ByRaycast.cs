    ...
    private void Update()
    {
        ...
        if (remainingAttackDuration > 0f)
        {
            ...
            for (int i = 0; i < raysToUse; ++i)
            {
                ...
                //Debug.DrawLine(Vector3.Lerp(oldRaycastStart, raycastStart.position, t), Vector3.Lerp(oldRaycastEnd, raycastEnd.position, t), Color.red, 0.5f);
                ...
                if (Physics.Linecast(startPoint, endPoint - startPoint, out RaycastHit hit, layerMask))
                {
